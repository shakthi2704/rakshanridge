                    ...
                    <div>
                        <Reveal>
                            <p className="font-serif text-2xl leading-relaxed text-charcoal">
                                <span className="float-left mr-3 mt-1 font-serif text-6xl leading-[0.85] text-navy sm:text-7xl">
                                    {openingFirstLetter}
                                </span>
                                {openingRest}
                            </p>
                        ...
                        <Reveal delay={100}>
                            <div className="relative my-10 pl-8">
                                <span className="absolute top-0 left-0 font-serif text-4xl leading-none text-navy/40">
                                    &ldquo;
                                </span>
