...
export default function ExperiencesGridClient({
    ...
    const heroKey = items.find((item) => item.featured)?.key;
                        ...
                        return (
                            ...
                            >
                                <Link
                                    ...
                                    className={`group relative block w-full overflow-hidden ${isHero ? "aspect-[16/9]" : "aspect-[4/5]"
                                        }`}
                                >
                                    <Image
                                        src={item.image}
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 p-6 sm:p-7">
                                        <h3
                                            className={`font-serif font-medium text-white ${isHero ? "text-2xl sm:text-3xl" : "text-xl"
                                                }`}
                                        >
                                            {item.title}
                                        </h3>
