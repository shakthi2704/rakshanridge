    ...
    return (
        <section className="bg-mist py-24 lg:py-32">
            <Container size="narrow">
                ...
                <div className="mt-16 space-y-0 border-l border-navy/15 pl-8 sm:pl-12">
                    {items.map((key, i) => (
                        <Reveal key={key} delay={300 + i * 100}>
                            <div className="relative pb-12 last:pb-0">
                                <span className="absolute -left-[calc(2rem+5px)] top-1.5 h-2.5 w-2.5 rounded-full bg-navy sm:-left-[calc(3rem+5px)]" />
