...
export type ButtonVariant = "primary" | "outline-white" | "outline-navy" | "ghost";
...
export function buttonVariants({
    ...
    return cn(
        // Base
        "inline-flex items-center justify-center font-sans font-medium uppercase tracking-[0.15em] rounded-md",
