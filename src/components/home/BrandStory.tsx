    ...
    return (
        <section className="relative overflow-hidden bg-paper py-24 lg:py-36">
            <Image
                ...
                width={500}
                height={650}
                className="pointer-events-none absolute right-0 bottom-0 z-0 w-64 opacity-20 sm:w-80 lg:w-[28rem]"
            />
            <Container>
                    ...
                    <div className="relative max-w-md">
                        ...
                        <Reveal>
                            <div className="flex items-center gap-4 text-slate">
                                ...
                                <span className="font-sans text-xs tracking-[0.25em] text-ink font-medium uppercase">
                                    {t("eyebrow")}
                                </span>
                            </div>
                        </Reveal>
                        ...
                        <Reveal delay={100}>
                            <h2 className="mt-6 font-serif text-3xl leading-[1.3] font-semibold  text-ink sm:text-4xl">
                                {t("heading")}
                            </h2>
                        </Reveal>
